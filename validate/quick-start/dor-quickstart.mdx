...
Refer to these guides on [Digital Ocean](/validate/setup-guides/do/sg-droplet), [AWS](/validate/setup-guides/aws/sg), [Digital Ocean](/validate/setup-guides/gcp/sg), and [Hetzner](https://docs.hetzner.com/cloud/firewalls/getting-started/creating-a-firewall/).
