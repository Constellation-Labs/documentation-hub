...
|-----------------|-------| -----------
| ingress         | 9000  | public api layer0
| ingress         | 9001  | p2p api layer0
| ingress         | 9010  | public api layer1
| ingress         | 9011  | p2p api layer1
| egress         | all  | Tune to your needs
...
- A `Wallet` that has `250,000 $DAG` tokens, to satify your collateral requirements. 
