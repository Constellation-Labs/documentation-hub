...
Learn about Stargazer wallet [here](/learn/tools-resources/wallets).
...
1. Review the contents of your wallet through the [Stargazer wallet application](/learn/tools-resources/wallets) and confirm that the $DAG has appeared in your wallet.
...
Once complete, review the contents again on both the [Stargazer wallet application](/learn/tools-resources/wallets) and from our node.
