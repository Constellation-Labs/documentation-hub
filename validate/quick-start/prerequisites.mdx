...
It does **NOT** include the [New Installation Start Guides](/validate/quick-start/index) or [Step-by-Step Guides](/validate/automated/install/nodectlInstallTypes). If you do not already have a node set up, you may skip this document and proceed directly to the [guide](/validate/quick-start/index) that pertains to your particular setup.
