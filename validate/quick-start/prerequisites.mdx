...
- Your node's **node ID** (public key) has been submitted to Constellation Network and confirmed it was placed on the authentication seed list.
  - IntegrationNet specific:
     - Lattice account is setup.
     - Node ID registered on Lattice account.
