...
Refer to the [specification](/validate/validator/specs#dor-metagraph-node-hardware-requirements) document for validation.
...
- Choose <kbd>4</kbd> (`dor [metagraph]`)
...
1. Supply and request to have your `nodeid` appended to the Dor metagraph access seed list.
...
Refer to the [collateralize your node start guide](/validate/quick-start/collateralize).
